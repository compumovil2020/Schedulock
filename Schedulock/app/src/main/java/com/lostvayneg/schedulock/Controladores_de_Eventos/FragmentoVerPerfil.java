...
public class FragmentoVerPerfil extends Fragment {
    ...
    private void cargarCantidadNotas(){
        referenciaBD = baseDatos.getReference(RUTA_NOTAS + FirebaseAuth.getInstance().getCurrentUser().getUid() + "/");
    ...
    private void cargarCantidadLogros(){
        referenciaBD = baseDatos.getReference(RUTA_LOGROS + FirebaseAuth.getInstance().getCurrentUser().getUid() + "/");
        referenciaBD.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
    ...
    private void cargarCantidadCalendarios(){
        referenciaBD = baseDatos.getReference(RUTA_CALENDARIOS + FirebaseAuth.getInstance().getCurrentUser().getUid() + "/");
        referenciaBD.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
    ...
    private void guardarCambios(){
        ...
        if(!nombre.isEmpty()){
            if(!edad.isEmpty()){
                ...
                referenciaBD = baseDatos.getReference(RUTA_USUARIOS + FirebaseAuth.getInstance().getCurrentUser().getUid());
